...
import { Loader2, CheckCircle2, Eye, EyeOff, ShieldCheck, Mail, RefreshCw } from 'lucide-react';
  ...
  return (
    <div className="h-screen flex w-full bg-zinc-50 dark:bg-[#09090b] relative overflow-hidden transition-colors duration-500">
      ...
      <div className="hidden lg:block w-1/2 relative bg-primary">
        <Image src="/how-it-works-goal.png" alt={t.brandTagline} fill className="object-cover" priority />
      </div>
