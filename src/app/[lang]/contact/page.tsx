...
async function page({ params }: PageProps) {
    ...
    const t = dictionary.pages.contact;
    ...
    return (
        <>
            ...
            <main className="min-h-screen bg-white">
                {/* Hero Section - Exact same style as your About page */}
                ...
                {/* Contact Form & Info Section - Using your Community Section grid logic */}
                <section className="py-24 relative overflow-x-hidden overflow-y-show">
                    <div className="w-full container px-4 mx-auto">
                        <div className="w-full justify-between items-start gap-12 grid lg:grid-cols-2 grid-cols-1">
                            ...
                            {/* Left Side: Info - Using your typography and spacing */}
                            <div className="w-full flex-col justify-center items-start gap-10 inline-flex">
                                <div className="w-full flex-col justify-center items-start gap-8 flex">
                                    <div className="space-y-4">
                                        ...
                                        <h3 className="text-4xl font-bold leading-tight text-zinc-900">
                                            {t.info.mainHeading}
                                        </h3>
                                    </div>

                                    {/* Info Blocks - Using your border-l-4 / bg-primary pattern */}
                                    <div className="w-full space-y-4 border-l-4 border-primary pl-6 py-2 bg-primary/[0.02] rounded-r-xl">
                                        <div className="flex items-center gap-4">
                                            <Coffee className="text-primary" size={24} />
                                            <h2 className="text-zinc-900 text-2xl font-bold">{t.info.coffee.title}</h2>
                                        </div>
                                        <p className="text-zinc-500 text-base leading-relaxed">{t.info.coffee.address}</p>
                                    </div>

                                    <div className="space-y-4">
                                        <div className="flex items-center gap-4">
                                            <Phone className="text-primary" size={24} />
                                            <h2 className="text-zinc-900 text-2xl font-bold">{t.info.reachOut.title}</h2>
                                        </div>
                                    ...
                                    <div className="space-y-4">
                                        <div className="flex items-center gap-4">
                                            ...
                                            <h2 className="text-zinc-900 text-2xl font-bold">{t.info.assist.title}</h2>
                                        </div>
                                        <p className="text-zinc-500 text-base leading-relaxed">
                            ...
                            {/* Right Side: Form - Using your rounded-[3rem] and shadow-xl style */}
                            <div className="w-full p-6 bg-white rounded-lg shadow-md border border-zinc-100 relative z-10">
                                <div className="space-y-8">
                                    <h3 className="text-3xl font-black text-zinc-900">{t.form.title}</h3>

                                    <div className="space-y-6">
                                        <div className="space-y-2">
                                            <p className="text-sm font-black text-zinc-900 ml-1">{t.form.nameLabel}</p>
                                            <div className="relative">
                                                <Input className="h-14 rounded-xl border-zinc-200 bg-zinc-50/50" placeholder={t.form.namePlaceholder} />
                                                <User className="absolute right-4 top-1/2 -translate-y-1/2 text-zinc-400" size={18} />
                                            </div>
                                        </div>

                                        <div className="space-y-2">
                                            <p className="text-sm font-black text-zinc-900 ml-1">{t.form.emailLabel}</p>
                                            <div className="relative">
                                                <Input className="h-14 rounded-xl border-zinc-200 bg-zinc-50/50" placeholder={t.form.emailPlaceholder} />
                                                <Mail className="absolute right-4 top-1/2 -translate-y-1/2 text-zinc-400" size={18} />
                                            </div>
                                        </div>

                                        <div className="space-y-2">
                                            <p className="text-sm font-black text-zinc-900 ml-1">{t.form.messageLabel}</p>
                                            <div className="relative">
                                        ...
                                        <Button size="lg" className="w-full rounded-full font-bold py-8 text-lg shadow-lg">
                    ...
                    <div className="absolute top-0 left-0 w-3/4 h-full bg-primary/5 -skew-x-12 translate-x-1/2" />
                    <div className="absolute -top-12 left-0 w-3/4 h-full bg-primary/7 -skew-x-12 translate-x-1/2" />

                </section>
                {/* Social Media Section */}
                <div className="py-24 flex flex-col items-center justify-center space-y-6">
                    <h4 className="text-zinc-900 font-bold uppercase tracking-widest text-sm">{t.social.heading}</h4>

                    <div className="flex space-x-4 justify-center">
                        {/* X / Twitter */}
                        <SocialLink href="#" className="w-12 h-12 bg-primary rounded-full flex items-center justify-center hover:scale-110 transition-transform shadow-lg shadow-primary/20">
