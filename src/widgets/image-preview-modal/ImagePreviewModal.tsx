// Ported from myUpskill's app/widgets/image-preview-modal/ImagePreviewModal.tsx
// — adapted CustomDialog import path only.
'use client';
        ...
        >
            <div className="space-y-4">
                <div className="flex justify-center gap-2 pb-2 border-b flex-wrap">
                    <Button variant="outline" size="sm" onClick={handleZoomIn} className="gap-1">Zoom In</Button>
                    <Button variant="outline" size="sm" onClick={handleZoomOut} className="gap-1">Zoom Out</Button>
                    <Button variant="outline" size="sm" onClick={handleRotate} className="gap-1">Rotate</Button>
                    <Button variant="outline" size="sm" onClick={handleReset} className="gap-1">Reset</Button>
                </div>
