export const aboutDict = {
  en: {
    hero: {
      title: "About Us",
      subtitle: "Qubit is a global intelligence platform dedicated to democratizing mathematics through artificial intelligence. We bridge the gap between complex logic and student potential, ensuring that anyone, anywhere, can master the language of the universe in their own native tongue.",
    },
    community: {
      title: "A Global Lab Where Logic Prevails",
      desc: "Mastering mathematics isn't just about memorizing formulas—it's about developing the neural pathways to solve the world's most pressing challenges. At Qubit, we adapt our AI to your cultural and linguistic context, making high-level STEM accessible to all.",
      foundedTitle: "Engineered by Visionaries",
      foundedDesc: "Qubit was built by a team of mathematicians and AI researchers who recognized that traditional education moves too slowly for the digital age. They saw that students didn't need more textbooks—they needed an adaptive, real-time logic engine that speaks their language.",
    ...
    founders: {
      ...
      storyDesc: "Founded by two experts in computational logic, Qubit was born from the realization that AI could provide the 1-on-1 personalized math guidance that humans simply can't scale.",
      creatorsLabel: "Meet the Architects",
      quote: "We built Qubit to be the cognitive partner we wished we had. Our mission is to ensure that a student's zip code never determines their ability to understand the laws of physics or finance.",
  ...
  fr: {
    hero: {
      title: "À Propos",
      subtitle: "Qubit est une plateforme d'intelligence mondiale dédiée à la démocratisation des mathématiques via l'IA. Nous comblons le fossé entre la logique complexe et le potentiel des étudiants.",
    },
    community: {
      ...
      foundedDesc: "Qubit a été créé par des mathématiciens et des chercheurs en IA qui ont compris que l'éducation traditionnelle est trop lente pour l'ère numérique.",
    ...
    founders: {
      ...
      storyDesc: "Fondée par des experts en logique computationnelle, Qubit est née pour offrir un guidage mathématique personnalisé à grande échelle.",
      creatorsLabel: "Rencontrez les Architectes",
      quote: "Nous avons construit Qubit pour être le partenaire cognitif que nous aurions aimé avoir.",
  ...
  es: {
    hero: {
      ...
      subtitle: "Qubit es una plataforma de inteligencia global dedicada a democratizar las matemáticas a través de la IA. Cerramos la brecha entre la lógica compleja y el potencial del estudiante.",
    },
    community: {
      ...
      foundedDesc: "Qubit fue construido por matemáticos e investigadores de IA que reconocieron que la educación tradicional avanza lento para la era digital.",
    ...
    founders: {
      ...
      storyDesc: "Fundada por expertos en lógica computacional, Qubit nació de la idea de que la IA puede dar guía matemática 1-a-1 personalizada.",
      creatorsLabel: "Conoce a los Arquitectos",
      quote: "Construimos Qubit para ser el compañero cognitivo que deseábamos tener.",
