export const faqDict = {
    en: {
        hero: {
            ...
            description: "Everything you need to know about our courses, methodology, and community. Can't find what you're looking for? Reach out to us."
        },
        items: [
            {
                question: "How do I choose the right course for my level?",
                answer: "We offer a free placement test that evaluates your speaking, listening, and grammar skills. Based on your results, our educators recommend the path that best matches your current proficiency and goals."
            },
            {
        ...
        cta: {
            ...
            subtitle: "Our team is here to help you navigate your learning journey.",
            primaryButton: "Contact Support",
            secondaryButton: "Live Chat"
        }
    },
    fr: {
        hero: {
            ...
            description: "Tout ce que vous devez savoir sur nos cours, notre méthodologie et notre communauté. Vous ne trouvez pas ce que vous cherchez ? Contactez-nous."
        },
        items: [
            {
                question: "Comment choisir le cours adapté à mon niveau ?",
                answer: "Nous proposons un test de placement gratuit qui évalue vos compétences à l'oral, à l'écoute et en grammaire. En fonction de vos résultats, nos éducateurs vous recommandent le parcours qui correspond le mieux à votre maîtrise actuelle et à vos objectifs."
            },
            {
        ...
        cta: {
            ...
            subtitle: "Notre équipe est là pour vous aider à orienter votre parcours d'apprentissage.",
            primaryButton: "Contacter le support",
            secondaryButton: "Chat en direct"
        }
    },
    es: {
        hero: {
            ...
            description: "Todo lo que necesitas saber sobre nuestros cursos, metodología y comunidad. ¿No encuentras lo que buscas? Contáctanos."
        },
        items: [
            {
                question: "¿Cómo elijo el curso adecuado para mi nivel?",
                answer: "Ofrecemos una prueba de nivel gratuita que evalúa tus habilidades de habla, escucha y gramática. Según tus resultados, nuestros educadores recomiendan el camino que mejor se adapte a tu competencia actual y objetivos."
            },
            {
        ...
        cta: {
            ...
            subtitle: "Nuestro equipo está aquí para ayudarte a navegar tu viaje de aprendizaje.",
            primaryButton: "Contactar Soporte",
            secondaryButton: "Chat en vivo"
        }
    }
};